...
## Metadata
- **Difficulty**: Easy
- **URL**: [LeetCode Problem URL](https://leetcode.com/problems/find-if-path-exists-in-graph/)
...
| -------- | ------- | ------ | --------- |
| [C++](solution.cpp) | 419 ms | 311.8 MB | 2026-05-05 |
| [C++](solution.cpp) | 372 ms | 311.7 MB | 2026-05-05 |
