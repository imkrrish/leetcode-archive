...
## Metadata
- **Difficulty**: Medium
- **URL**: [LeetCode Problem URL](https://leetcode.com/problems/maximize-active-section-with-trade-i/)
...
| -------- | ------- | ------ | --------- |
| [C++](solution.cpp) | 85 ms | 80.8 MB | 2026-07-22 |
| [C++](solution.cpp) | 75 ms | 80.8 MB | 2026-07-21 |
