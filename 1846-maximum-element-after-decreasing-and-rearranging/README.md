...
## Metadata
- **Difficulty**: Medium
- **URL**: [LeetCode Problem URL](https://leetcode.com/problems/maximum-element-after-decreasing-and-rearranging/)
...
- **Input:** `arr = [2,2,1,2,1]`
- **Output:** `2`
- **Explanation:** We can satisfy the conditions by rearranging arr so it becomes [1,2,2,2,1].
...
| -------- | ------- | ------ | --------- |
| [C++](solution.cpp) | 11 ms | 55.2 MB | 2026-06-28 |
